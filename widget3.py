...
class SBN_Comp_Tools:
    def __init__(self, top=None):
        ...
        self.TCheckbutton1 = ttk.Checkbutton(self.TNotebook1_pg1)
        self.TCheckbutton1.place(relx=0.66, rely=0.19, relwidth=0.11
                , relheight=0.0, height=18)
        self.TCheckbutton1.configure(variable=widget3_support.tch87)
        self.TCheckbutton1.configure(takefocus="")
        self.TCheckbutton1.configure(text='''Pop-Up''')
        ...
        self.TCheckbutton3 = ttk.Checkbutton(self.TNotebook1_pg1)
        self.TCheckbutton3.place(relx=0.66, rely=0.33, relwidth=0.17
                , relheight=0.0, height=18)
        self.TCheckbutton3.configure(variable=widget3_support.tch91)
        self.TCheckbutton3.configure(takefocus="")
        self.TCheckbutton3.configure(text='''Spout Adapt''')
        ...
        self.TCheckbutton4 = ttk.Checkbutton(self.TNotebook1_pg1)
        self.TCheckbutton4.place(relx=0.32, rely=0.33, relwidth=0.17
                , relheight=0.0, height=18)
        self.TCheckbutton4.configure(variable=widget3_support.tch40)
        self.TCheckbutton4.configure(takefocus="")
        self.TCheckbutton4.configure(text='''Sqaure Grate''')

        self.TCheckbutton5 = ttk.Checkbutton(self.TNotebook1_pg1)
        self.TCheckbutton5.place(relx=0.32, rely=0.05, relwidth=0.08
                , relheight=0.0, height=18)
        self.TCheckbutton5.configure(variable=widget3_support.tch41)
        self.TCheckbutton5.configure(takefocus="")
        self.TCheckbutton5.configure(text='''Y-Fit''')

        self.TCheckbutton6 = ttk.Checkbutton(self.TNotebook1_pg1)
        self.TCheckbutton6.place(relx=0.32, rely=0.19, relwidth=0.13
                , relheight=0.0, height=18)
        self.TCheckbutton6.configure(variable=widget3_support.tch42)
        self.TCheckbutton6.configure(takefocus="")
        self.TCheckbutton6.configure(text='''Coupling''')
        ...
        self.e_squaregrate.configure(width=46)
        ...
        self.e_coupling.configure(width=46)
        ...
        self.e_yfit.configure(width=46)

        self.TCheckbutton2 = ttk.Checkbutton(self.TNotebook1_pg1)
        self.TCheckbutton2.place(relx=0.66, rely=0.05, relwidth=0.17
                , relheight=0.0, height=18)
        self.TCheckbutton2.configure(variable=widget3_support.tch46)
        self.TCheckbutton2.configure(takefocus="")
        self.TCheckbutton2.configure(text='''Trench Grate''')

        self.e_trenchgrate = ttk.Entry(self.TNotebook1_pg1)
        self.e_trenchgrate.place(relx=0.86, rely=0.05, relheight=0.09
                , relwidth=0.07)
        self.e_trenchgrate.configure(width=44)
        self.e_trenchgrate.configure(takefocus="")
        self.e_trenchgrate.configure(cursor="xterm")
        ...
        self.b_estimate = Button(self.Frame3, command = self.main)
